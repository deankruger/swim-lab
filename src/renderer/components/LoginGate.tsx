        ...
        <div className="login-gate">
            <div className="login-gate-card">
                <div className="login-gate-icon">
                    <svg width="72" height="72" viewBox="0 0 122.88 82.13" xmlns="http://www.w3.org/2000/svg">
                        <g fill="currentColor">
                ...
                <h2 className="login-gate-heading">Welcome to Swim Lab</h2>
                <p className="login-gate-description">
                    Search swimmers, save your favourites, and compare times against county
                    standards. Sign in to keep your data synced across devices.
                </p>
                <button
                    type="button"
                    className="auth-button login-gate-button"
