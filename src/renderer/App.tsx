...
import { siblings } from 'cheerio/dist/commonjs/api/traversing';
            ...
            <header>
                <div className="header-content">
                    <div className="header-icon">
                        <svg width="52" height="52" viewBox='0 0 122.88 82.13' xmlns='http://www.w3.org/2000/svg'>
                            <g fill='black'> {/*<g fill='currentColor'> */}
                ...
                <div className="header-text">
                    <h1>Swim Lab</h1>
                    <p>Review and compare swimmer times and rankings from conty to national levels</p>
                </div>
                <ThemeSelector />
            </header>
            <main>
